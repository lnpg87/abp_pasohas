...
{
    public abstract class qWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(qWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<qDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<qDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<qDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<qDbContext, Task<T>> func)
        {
            T result;
