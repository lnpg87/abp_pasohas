...
namespace q.Migrations
{
    ...
    [Migration("20230327010716_adding-provincia")]
    partial class addingprovincia
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("q.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("q.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("q.Models.Generales.UbicacionNs.PaisNs.Pais", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("q.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("q.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("q.Authorization.Roles.Role", b =>
                {
                    b.HasOne("q.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("q.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("q.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
