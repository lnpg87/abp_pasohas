...
export class PaisServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<PaisDto> {
     ...
     * @param filterProperties (optional)
     * @param skipCount (optional)
     * @param maxResultCount (optional)
     * @return Success
     */
    getAll(sorting: string | undefined, filter: string | undefined, filterProperties: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<PaisDtoPagedResultDto> {
        ...
        if (filterProperties === null)
            throw new Error("The parameter 'filterProperties' cannot be null.");
        else if (filterProperties !== undefined)
            url_ += "FilterProperties=" + encodeURIComponent("" + filterProperties) + "&";
        if (skipCount === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PaisDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaisDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PaisDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaisDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    create(body: PaisDto | undefined): Observable<PaisDto> {
     ...
     * @return Success
     */
    update(body: PaisDto | undefined): Observable<PaisDto> {
...
export class ProvinciaServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ProvinciaDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ProvinciaDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ProvinciaDto>;
        }));
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<ProvinciaDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ProvinciaDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, filter: string | undefined, filterProperties: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ProvinciaDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ProvinciaDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ProvinciaDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ProvinciaDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ProvinciaDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    create(body: ProvinciaDto | undefined): Observable<ProvinciaDto> {
     ...
     * @return Success
     */
    update(body: ProvinciaDto | undefined): Observable<ProvinciaDto> {
...
export class RoleServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, filter: string | undefined, filterProperties: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<RoleDtoPagedResultDto> {
...
export class PaisDto implements IPaisDto {
    ...
    descripcionCodigoIso!: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.descripcionCodigoIso = _data["descripcionCodigoIso"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["descripcionCodigoIso"] = this.descripcionCodigoIso;
        return data;
    }
}
...
export class PaisDtoPagedResultDto implements IPaisDtoPagedResultDto {
    items!: PaisDto[] | undefined;
    totalCount!: number;

    constructor(data?: IPaisDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PaisDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaisDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IPaisDtoPagedResultDto {
    items: PaisDto[] | undefined;
    totalCount: number;
}
...
export class ProvinciaDto implements IProvinciaDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.paisDescripcion = _data["paisDescripcion"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["paisDescripcion"] = this.paisDescripcion;
        return data;
    }
}
...
export class ProvinciaDtoPagedResultDto implements IProvinciaDtoPagedResultDto {
    items!: ProvinciaDto[] | undefined;
    totalCount!: number;

    constructor(data?: IProvinciaDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProvinciaDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProvinciaDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IProvinciaDtoPagedResultDto {
    items: ProvinciaDto[] | undefined;
    totalCount: number;
}
